...
**Title:** Cross-Family Non-Uniqueness in Polarization-Resolved Optical
Characterization of Polydisperse Spheroids
...
Accordingly, this archive reproduces all reported ensemble analyses from the
...
- `CHECKSUMS.sha256` -- SHA-256 integrity record for every other file

On Linux or macOS, verify the archive after extraction with:
...
beyond peer review and verification of the published results, contact the
